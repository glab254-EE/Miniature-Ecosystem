...
public class SecurePlayerPrefs {
   ...
   */
	private static readonly string PRIVATE_KEY_PREFIX = "skib";
	private static readonly string PRIVATE_KEY_RAND = "idi";
	private static readonly string PRIVATE_KEY_SUFFIX = "a";
  ...
  // Your private key to store the randomly generated key for each device.
	private static readonly string RAND_KEY = "amogusus";
